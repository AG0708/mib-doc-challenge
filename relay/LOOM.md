...
2. Leave the **Loom teleprompter** open (bottom-right). It auto-tracks the route.
...
**Do:** Select a prospect → advance one stage. Name the owner out loud.
...
**Do:** Click payout status filters. Point at attribution bars.
