...
_OCR_KEEP_RE = re.compile(
    ...
    r"illegible|identity_confl|rescind|leglt|leglble|biemtrice|boglcl|bogile|"
    r"oglo_bicm|Bitl_omet|ilgible_biom|bicmotric|RISK\s*PANEL|IRIS\s*PANEL|RESKPANEL|"
    r"fflags|fisgs|fiogs|flegs|Cbeeved|CRsarvnd|Obeerwed|Upserved|"
...
def _normalize_ocr_spacing(text: str) -> str:
    ...
    replacements = [
        ...
        (r"oObserObserved flags:", "Observed flags: "),
        (r"serObserved flags:", "Observed flags: "),
        ...
        (r"(?<![A-Za-z])ved flogs:", "Observed flags: "),
        (r"(?<![A-Za-z])ved flags:", "Observed flags: "),
        ...
        (r"Observed\s*fflags\s*:", "Observed flags: "),
        (r"Observed\s*fiogs\s*:", "Observed flags: "),
        (r"Observed\s*fisgs\s*:", "Observed flags: "),
        (r"Observed\s*flegs\s*:", "Observed flags: "),
        (r"Obsered\s*flags?\s*:", "Observed flags: "),
        (r"Cbeeved\s*floge\s*:", "Observed flags: "),
        (r"CRsarvnd\s*fisgs\s*:", "Observed flags: "),
        (r"Obeerwed\s*flegs\s*:", "Observed flags: "),
        (r"Oteedfngr\s*:", "Observed flags: "),
        # Glued header+flags OCR (Upservedtiag / Upserved tiag)
        (r"Upservedtiag\s*:?\s*", "Observed flags: "),
        (r"Upserved\s*tiag\s*:?\s*", "Observed flags: "),
        ...
        (r"leglble_blomatics", "illegible_biometrics"),
        (r"Begin\s*biemtrice", "illegible_biometrics"),
        (r"Boglcl_bometrics", "illegible_biometrics"),
        (r"Bogile_biometics", "illegible_biometrics"),
        (r"oglo_bicmotrics", "illegible_biometrics"),
        (r"Bitl_ometics", "illegible_biometrics"),
        (r"ilgible_biomtica", "illegible_biometrics"),
        (r"illegible_biom\b", "illegible_biometrics"),
        (r"ilenibla\.?\s*biometrics", "illegible_biometrics"),
        (r"Igili_bim\b", "illegible_biometrics"),
        # Multiline: Observed flags: \n_biometrics
        (r"Observed flags:\s*_biometrics\b", "Observed flags: illegible_biometrics"),
        (r"identity_conflit\b", "identity_conflict"),
        (r"ntty_conficf\b", "identity_conflict"),
        (r"Idertay_condict\w*", "identity_conflict"),
        (r"\[RESKPANEL", "[RISK PANEL"),
        (r"\[IRISKPANEL", "[RISK PANEL"),
        (r"\[IRIS\s*PANEL", "[RISK PANEL"),
        (r"RESKPANEL\s*MISSING", "RISK PANEL MISSING"),
        (r"RESKPANEL\s*NG", "RISK PANEL MISSING"),
        (r"IRISKPANEL\s*MISSING", "RISK PANEL MISSING"),
        (r"IRIS\s*PANEL\s*MISSING", "RISK PANEL MISSING"),
        # Flags-line quality stamps (smear/blur/cutout) → panel-missing channel
        (r"Observed flags:\s*\[?\s*SMEAR\s*\]?", "Observed flags: [RISK PANEL MISSING]"),
        (r"Observed flags:\s*\[?\s*BLURR?\s*\]?", "Observed flags: [RISK PANEL MISSING]"),
        (r"Observed flags:\s*\[?\s*CUT\s*OUT\s*\]?", "Observed flags: [RISK PANEL MISSING]"),
        (r"Observed flags:\s*\[?\s*CUTOUT\s*\]?", "Observed flags: [RISK PANEL MISSING]"),
        ...
        (r"IRISKPANEL\s*NG", "RISK PANEL MISSING"),
        (r"RISK\s*PANEL\s*NG", "RISK PANEL MISSING"),
        (r"\bpold\b", "paid"),
        (r"\bpod\b", "paid"),
        (r"\bpald\b", "paid"),
        (r"\bnaid\b", "paid"),
